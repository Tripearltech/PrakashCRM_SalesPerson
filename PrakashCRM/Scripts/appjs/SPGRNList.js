...
$(document).ready(function () {
    ...
    $('#ddlField').change(function () {
        ...
        if ($('#ddlField').val() == "OrderDate_Filter_FilterOnly") {
...
function bindGridData(skip, top, firsload, orderBy, orderDir, filter) {
    ...
    //$.get(apiUrl + 'GetApiRecordsCount?SPCode=' + $('#hdnLoggedInUserSPCode').val() + '&apiEndPointName=InquiryDotNetAPI&filter=' + filter, function (data) {
    //    $('#hdnSPIQCount').val(data);
    //});

    $.ajax(
        {
            url: '/SPGRN/GetGRNListData?orderBy=' + orderBy + '&orderDir=' + orderDir + '&filter=' + filter,
            type: 'GET',
            ...
            success: function (data) {
                ...
                $.each(data, function (index, item) {
                    ...
                    var rowData = "<tr><td></td><td><a href='/SPGRN/GRNCard?No=" + item.DocumentNo + "&DocumentType=" + item.DocumentType + "'><span>" + item.DocumentNo + "</span></a></td><td>" + item.OrderDate + "</td><td>" + item.Name + "</td><td>" + item.DocumentType + "</td><td>" + item.ProductName + "</td><td>" + item.OutstandingQty + "</td><td>" + item.PackingStyle + "</td><td>" + item.PurchaserName + "</td><td>" + item.ContactName + "</td><td>" + item.ContactPhoneNo + "</td></tr>";
