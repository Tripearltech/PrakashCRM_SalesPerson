var apiUrl = $('#getServiceApiUrl').val() + 'SPRoles/';
...
function bindGridData(skip, top, firsload, orderBy, orderDir, filter) {
    ...
    $.ajax(
        {
            url: '/SPRoles/GetRoleListData?orderBy=' + orderBy + '&orderDir=' + orderDir + '&filter=' + filter + '&skip=' + skip + '&top=' + top,
            type: 'GET',
            ...
            success: function (data) {
                ...
                $.each(data, function (index, item) {
                    ...
                    var rowData = "<tr><td></td><td><a class='EditRoleCls' href='/SPRoles/Role?No=" + item.No + "'><i class='bx bxs-edit'></i></a>&nbsp;&nbsp;<a class='DeleteRoleCls' onclick='showDelPopup(this)'><i class='bx bxs-trash'></i></a></td><td name='RoleNo'>" + item.No + "</td><td name='RoleName'>" + item.Role_Name + "</td>";
...
function pageMe() {
    ...
    var numItems = $('#hdnRoleCount').val(); //32;
...
function exportGridData(skip, top, firsload, orderBy, orderDir, filter) {
    $.ajax(
        {
            url: '/SPRoles/ExportListData?orderBy=' + orderBy + '&orderDir=' + orderDir + '&filter=' + filter + '&skip=' + skip + '&top=' + top,
            type: 'GET',
            contentType: 'application/json',
            success: function (data) {
                ...
                if (data.fileName != "") {
                    ...
                    window.location.href = "/SPRoles/Download?file=" + data.fileName;
                }
            },
...
function showDelPopup(obj) {
    ...
    $('#hdnRoleNo').val(row.find("[name=RoleNo]").text());
    $('#hdnRoleName').val(row.find("[name=RoleName]").text());

    $('#modalDelRole').css('display', 'block');
