...
function bindGridData(skip, top, firsload, orderBy, orderDir, filter) {
    ...
    $.get(apiUrl + 'GetApiRecordsCount?SPCode=' + $('#hdnLoggedInUserSPCode').val() + '&apiEndPointName=BusinessPlanListDotNetAPI&filter=' + filter, function (data) {
        $('#hdnPendingApprovalCnt').val(data);
    });

    $.ajax(
        {
            url: '/SPBusinessPlan/GetBusinessPlanApprovalData?orderBy=' + orderBy + '&orderDir=' + orderDir + '&filter=' + filter + '&skip=' + skip + '&top=' + top,
            type: 'GET',
            ...
            success: function (data) {
                ...
                $.each(data, function (index, item) {
                    var rowData = "<tr><td></td><td>" + item.No + "</td><td>" + item.Name + "</td><td>" + item.City + "</td><td>" + item.Post_Code + "</td><td>" + item.Phone_No + "</td><td>" + item.E_Mail + "</td><td>" + item.Balance_Due_LCY + "</td><td>" + item.ContactName + "</td><td>" + item.MobilePhoneNo + "</td><td>" + item.Salesperson_Code + "</td><td>";

                    if (item.IsActive == true) {
                        rowData = rowData + "<span class='badge bg-success'>Active</span>";
                    }
                    else {
                        rowData = rowData + "<span class='badge bg-danger'>InActive</span>";
                    }
