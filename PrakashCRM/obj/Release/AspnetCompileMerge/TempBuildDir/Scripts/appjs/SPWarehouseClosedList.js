    ...
    $.ajax(
        {
            ...
            success: function (data) {
                ...
                var documentno = "";
                var innerrow = "";
                var innerstart = "<tr><td></td><td colspan='8'><table>";
                var innerend = "</table></td><td class='displaynone'></td><td class='displaynone'></td><td class='displaynone'></td><td class='displaynone'></td><td class='displaynone'></td><td class='displaynone'></td><td class='displaynone'></td><td class='displaynone'></td></tr>";
                ...
                $.each(data, function (index, item) {
                    ...
                    if (documentno != item.DocumentNo) {
                        ...
                        //debugger;
                        if (item.AcceptedBy == "") {
                            var rowData = "<tr><td><input type='checkbox' class='form-check-input' value='" + item.SystemId + "," + item.DocumentType + "' /></td></td><td><a href='/SPWarehouse/WarehouseCard?No=" + item.DocumentNo + "&DocumentType=" + item.DocumentType + "'><span>" + item.DocumentNo + "</span></a></td><td>" + item.ShipmentDate + "</td><td>" + item.CustomerVendorName + "</td><td>" + item.DocumentType + "</td><td>" + item.AcceptedBy + "</td><td>" + item.IncoTerm + "</td><td>" + item.FromAddress + "</td><td>" + item.ToAddress + "</td></tr>";
                        }
                        else {
                            var rowData = "<tr><td></td></td><td><a href='/SPWarehouse/WarehouseClosedCard?No=" + item.DocumentNo + "&DocumentType=" + item.DocumentType + "'><span>" + item.DocumentNo + "</span></a></td><td>" + item.ShipmentDate + "</td><td>" + item.CustomerVendorName + "</td><td>" + item.DocumentType + "</td><td>" + item.AcceptedBy + "</td><td>" + item.IncoTerm + "</td><td>" + item.FromAddress + "</td><td>" + item.ToAddress + "</td></tr>";
                        }
                        ...
                        innerrow += "<tr><td>" + item.ItemNo + "</td><td>" + item.ItemDescription + "</td><td>" + item.Qty + "</td><td>" + item.UOM + "</td><td>" + item.PackingStyle + "</td><td>" + item.TransportQty + "</td><td>" + item.DropShipment + "</td><td>" + item.DropShipmentVendor + "</td></tr>";
