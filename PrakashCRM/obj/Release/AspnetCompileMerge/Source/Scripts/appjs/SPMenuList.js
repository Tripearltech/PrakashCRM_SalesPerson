var apiUrl = $('#getServiceApiUrl').val() + 'SPMenus/';
...
$(document).ready(function () {
    ...
    $('#btnSearch').click(function () {
        if ($('#ddlField').val() == "-1" || $('#ddlOperator').val() == "-1" || $('#txtSearch').val() == "") {
            ...
            filter += " and IsActive eq " + JSON.parse($('#ddlStatus').val());
...
function pageMe() {
    ...
    var numItems = $('#hdnMenuCount').val(); //32;
    ...
    $.ajax(
        {
            ...
            success: function (data) {
                ...
                if (data.fileName != "") {
                    ...
                    window.location.href = "/SPMenus/Download?file=" + data.fileName;
                }
            },
