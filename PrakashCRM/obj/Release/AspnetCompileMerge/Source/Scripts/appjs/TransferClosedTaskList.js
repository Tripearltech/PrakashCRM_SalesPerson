...
function bindGridData(skip, top, firsload, orderBy, orderDir, filter) {
    ...
    $.get(apiUrl + 'GetClosedApiRecordsCount?apiEndPointName=TransferOrderDotNetAPI&filter=' + filter, function (data) {
        $('#hfCloseTaskCount').val(data);
    });

    $.ajax(
        {
            url: '/SPWarehouseTransfer/GetWarehouseClosedTaskListData?orderBy=' + orderBy + '&orderDir=' + orderDir + '&filter=' + filter + '&skip=' + skip + '&top=' + top,
            type: 'GET',
            ...
            success: function (data) {
                ...
                $.each(data, function (index, item) {
                    ...
                    var rowData = "<tr><td><a class='ViewInqProdCls' onclick='ShowTransferLines(\"" + item.No + "\")'><i class='bx bx-show'></i></a></td><td>" + item.No + "</td><td>" + item.Transfer_from_Code + "</td><td>" + item.Transfer_from_Name + "</td><td>" + item.Transfer_to_Code + "</td><td>" + item.Transfer_to_Name + "</td><td>" + item.Shipment_Date + "</td><td>" + item.PCPL_Transporter_No + "</td><td>" + item.PCPL_Freight_Charges + "</td><td>" + item.LR_RR_No + "</td><td>" + item.LR_RR_Date + "</td><td>" + item.PCPL_Driver_Name + "</td><td>" + item.PCPL_Driver_Mobile_No + "</td><td>" + item.PCPL_Driver_License_No + "</td><td>" + item.Vehicle_No + "</td></tr>";// 
