...
var apiUrl = $('#getServiceApiUrl').val() + 'SPWarehouseSales/';
...
function bindGridData(skip, top, firsload, orderBy, orderDir, filter) {
    ...
    $.get(apiUrl + 'GetClosedApiRecordsCount?apiEndPointName=SalesOrderCardDotNetAPI&filter=' + filter, function (data) {
        $('#hdnWSITaskCount').val(data);
    });

    $.ajax(
        {
            url: '/SPWarehouseSales/GetWarehouseClosedTaskListData?orderBy=' + orderBy + '&orderDir=' + orderDir + '&filter=' + filter + '&skip=' + skip + '&top=' + top,
            type: 'GET',
            ...
            success: function (data) {
                ...
                $.each(data, function (index, item) {
                    var rowData = "<tr><td><a class='ViewInqProdCls' onclick='ShowSalesLines(\"" + item.No + "\")'><i class='bx bx-show'></i></a></td><td>" + item.No + "</td><td>" + item.Sell_to_Customer_No + "</td><td>" + item.Sell_to_Customer_Name + "</td><td>" + item.Location_Code + "</td><td>" + item.Shipment_Date + "</td><td>" + item.PCPL_Transporter_No + "</td><td>" + item.PCPL_Fraight_Charges + "</td><td>" + item.LR_RR_No + "</td><td>" + item.LR_RR_Date + "</td><td>" + item.PCPL_Driver_Name + "</td><td>" + item.PCPL_Driver_Mobile_No + "</td><td>" + item.PCPL_Driver_License_No + "</td><td>" + item.Vehicle_No + "</td></tr>";// 
...
function ShowSalesLines(Document_No) {
    ...
    $.ajax(
        {
            url: '/SPWarehouseSales/GetAllSalesLineForPopup?Document_No=' + Document_No,
            type: 'GET',
            contentType: 'application/json',
            success: function (data) {
...
function exportGridData(skip, top, firsload, orderBy, orderDir, filter) {
    $.ajax(
        {
            url: '/SPWarehouseSales/ExportListData?orderBy=' + orderBy + '&orderDir=' + orderDir + '&filter=' + filter + '&skip=' + skip + '&top=' + top,
            type: 'GET',
            contentType: 'application/json',
            success: function (data) {
                //alert(data);
                ...
                if (data.fileName != "") {
                    ...
                    window.location.href = "/SPWarehouseSales/Download?file=" + data.fileName;
                }
            },
